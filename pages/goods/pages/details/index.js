...
Page({
  ...
  gotoBuy(type) {
    ...
    const query = {
      ...
      goodsName: this.data.details.dishName,
      ...
      title: this.data.details.dishName,
    };
  ...
  getDetail(pageIndex,storeId,spuId) {
    Promise.all([fetchGood(pageIndex,storeId,spuId), fetchActivityList()]).then((res) => {
  ...
  onShareAppMessage() {
    ...
    const customInfo = {
      ...
      title: this.data.details.dishName + shareSubTitle,
  ...
  navToCommentsListPage() {
    wx.navigateTo({
      url: `/pages/goods/pages/comments/index?spuId=${this.data.spuId}`,
    });
  },
